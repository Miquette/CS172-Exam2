...
//////////////////////////
// I affirm that all code given below was written solely by me, Miquette,
...
int main()
{
	...
	////// ANSWER: Red Bull Rampage 2016 top finishers/////////////////////////////////////////////////////////////
	...
	else
	{
		...
		if (Richard->getfavcolor() == "Pink")
		{
			Richard->setfavcolor("Purple");
		}
		else if (Richard->getfavcolor() == "Purple")
		{
